...
int main() {
    ...
    push_data(byte_data, 0b0010011000000100);
    push_data(byte_data, 0b0011000000000011);
    push_data(byte_data, 0b0010010000000010);
    push_data(byte_data, 0b1111000000000000);
    push_data(byte_data, 0b0000000000000101);
    size_t code_seg = byte_data->count;

    write_bin_to_file(byte_data, "out.dat");
}
